(function (factory, window) {
    ...
    L.Control.GeoapifyAddressSearch = L.Control.extend({
        ...
        options: {
            ...
            noResultsPlaceholder: "Pas de résultats trouvés..",
            resultCallback: null,
        ...
        _generateUrl: function (value) {
            let url = `${this.options.autocompleteUrl}?text=${encodeURIComponent(value)}&filter=countrycode:fr&apiKey=${this._apiKey}&format=json`;
